...
def _build_model(model_name: str, device: str | None, out_dir: Path) -> object:
    ...
    registry = {
        ...
        "llava_symDPO": lambda: LLaVAProber(device=device, adapter_path="results/rl_alignment/final", model_name="llava_symDPO"),
...
def _is_vlm(model_name: str) -> bool:
    return model_name in {"llava_1.5", "llava_1.5_dpo", "llava_symDPO", "qwen_vl"}
